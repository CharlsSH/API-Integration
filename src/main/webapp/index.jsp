    ...
    <div class="panel panel-primary">
      ...
      <div class="panel-body">
        <dl>
            ...
            <dt><a href="examples/sign-workflow-request.jsp">Prepare signature request (with workflow)</a></dt>
            <dd>Choose a Viafirma Inbox user, a PDF file and a Viafirma Inbox workflow, and prepare a signature request</dd>
        </dl>
      </div>
    </div>
</section>
